    ...
    class Context : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Hotel>(
                h =>
                {
                    h.Property(h => h.capacidad).HasColumnType("int");
            ...
            modelBuilder.Entity<Hotel>().HasData(
                new { id = 1, nombre = "Hotel Buenos Aires", capacidad = 101, costo = 110000.00, ciudad_fk = 7 },
                new { id = 2, nombre = "Hotel Rosario", capacidad = 80, costo = 120000.00, ciudad_fk = 2 },
                new { id = 3, nombre = "Hotel Córdoba", capacidad = 120, costo = 170000.00, ciudad_fk = 3 },
                new { id = 4, nombre = "Hotel Mendoza", capacidad = 90, costo = 140000.00, ciudad_fk = 4 },
                new { id = 5, nombre = "Hotel San Juan", capacidad = 70, costo = 110000.00, ciudad_fk = 5 },
                new { id = 6, nombre = "Hotel Mar del Plata", capacidad = 110, costo = 160000.00, ciudad_fk = 6 },
                new { id = 7, nombre = "Hotel Tucumán", capacidad = 95, costo = 135000.00, ciudad_fk = 7 },
                new { id = 8, nombre = "Hotel Salta", capacidad = 75, costo = 125000.00, ciudad_fk = 8 },
                new { id = 9, nombre = "Hotel Jujuy", capacidad = 85, costo = 145000.00, ciudad_fk = 9 },
                new { id = 10, nombre = "Hotel Neuquén", capacidad = 105, costo = 155000.00, ciudad_fk = 10 },
                new { id = 11, nombre = "Hotel La Plata", capacidad = 80, costo = 120000.00, ciudad_fk = 1 },
                new { id = 12, nombre = "Hotel Santa Fe", capacidad = 110, costo = 165000.00, ciudad_fk = 2 },
                new { id = 13, nombre = "Hotel San Luis", capacidad = 90, costo = 130000.00, ciudad_fk = 3 },
                new { id = 14, nombre = "Hotel Formosa", capacidad = 70, costo = 110000.00, ciudad_fk = 4 },
                new { id = 15, nombre = "Hotel Entre Ríos", capacidad = 100, costo = 150000.00, ciudad_fk = 5 },
                new { id = 16, nombre = "Hotel Catamarca", capacidad = 120, costo = 120000.00, ciudad_fk = 6 },
                new { id = 17, nombre = "Hotel La Rioja", capacidad = 120, costo = 175000.00, ciudad_fk = 7 },
                new { id = 18, nombre = "Hotel Chaco", capacidad = 95, costo = 140000.00, ciudad_fk = 8 },
                new { id = 19, nombre = "Hotel Tierra del Fuego", capacidad = 75, costo = 125000.00, ciudad_fk = 9 },
                new { id = 20, nombre = "Hotel Santa Cruz", capacidad = 105, costo = 155000.00, ciudad_fk = 10 },
                new { id = 2021, nombre = "PRUEBA", capacidad = 101, costo = 110000.00, ciudad_fk = 7 });

            modelBuilder.Entity<Vuelo>().HasData(
                new { id = 1, capacidad = 150, vendido = 0, costo = 120000.00, fecha = DateTime.Parse("2023-10-01 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Boeing 747", origen_fk = 1, destino_fk = 3 },
                new { id = 2, capacidad = 120, vendido = 0, costo = 110000.00, fecha = DateTime.Parse("2023-10-02 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Airbus A320", origen_fk = 2, destino_fk = 4 },
                new { id = 3, capacidad = 180, vendido = 0, costo = 140000.00, fecha = DateTime.Parse("2023-10-03 09:00:00"), aerolinea = "Aerolínea Mendoza", avion = "Boeing 787 Dreamliner", origen_fk = 3, destino_fk = 5 },
                new { id = 4, capacidad = 160, vendido = 0, costo = 125000.00, fecha = DateTime.Parse("2023-10-04 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Airbus A320", origen_fk = 4, destino_fk = 1 },
                new { id = 5, capacidad = 130, vendido = 0, costo = 130000.00, fecha = DateTime.Parse("2023-10-05 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Boeing 747", origen_fk = 5, destino_fk = 2 },
                new { id = 6, capacidad = 170, vendido = 0, costo = 135000.00, fecha = DateTime.Parse("2023-10-06 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Boeing 787 Dreamliner", origen_fk = 1, destino_fk = 3 },
                new { id = 7, capacidad = 140, vendido = 0, costo = 128000.00, fecha = DateTime.Parse("2023-10-07 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Airbus A320", origen_fk = 2, destino_fk = 4 },
                new { id = 8, capacidad = 110, vendido = 0, costo = 115000.00, fecha = DateTime.Parse("2023-10-08 09:00:00"), aerolinea = "Aerolínea Mendoza", avion = "Boeing 747", origen_fk = 3, destino_fk = 5 },
                new { id = 9, capacidad = 190, vendido = 0, costo = 145000.00, fecha = DateTime.Parse("2023-10-09 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Boeing 787 Dreamliner", origen_fk = 4, destino_fk = 1 },
                new { id = 10, capacidad = 155, vendido = 0, costo = 127000.00, fecha = DateTime.Parse("2023-10-10 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Airbus A320", origen_fk = 5, destino_fk = 2 },
                new { id = 11, capacidad = 170, vendido = 0, costo = 135000.00, fecha = DateTime.Parse("2023-10-11 09:00:00"), aerolinea = "Aerolínea Mendoza", avion = "Boeing 747", origen_fk = 1, destino_fk = 3 },
                new { id = 12, capacidad = 120, vendido = 0, costo = 110000.00, fecha = DateTime.Parse("2023-10-12 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Boeing 787 Dreamliner", origen_fk = 2, destino_fk = 4 },
                new { id = 13, capacidad = 140, vendido = 0, costo = 128000.00, fecha = DateTime.Parse("2023-10-13 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Airbus A320", origen_fk = 3, destino_fk = 5 },
                new { id = 14, capacidad = 180, vendido = 0, costo = 140000.00, fecha = DateTime.Parse("2023-10-14 09:00:00"), aerolinea = "Aerolínea Mendoza", avion = "Boeing 747", origen_fk = 4, destino_fk = 1 },
                new { id = 15, capacidad = 130, vendido = 0, costo = 130000.00, fecha = DateTime.Parse("2023-10-15 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Boeing 787 Dreamliner", origen_fk = 5, destino_fk = 2 },
                new { id = 16, capacidad = 150, vendido = 0, costo = 120000.00, fecha = DateTime.Parse("2023-10-16 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Airbus A320", origen_fk = 1, destino_fk = 3 },
                new { id = 17, capacidad = 160, vendido = 0, costo = 125000.00, fecha = DateTime.Parse("2023-10-17 09:00:00"), aerolinea = "Aerolínea Mendoza", avion = "Boeing 747", origen_fk = 2, destino_fk = 4 },
                new { id = 18, capacidad = 190, vendido = 0, costo = 145000.00, fecha = DateTime.Parse("2023-10-18 09:00:00"), aerolinea = "Aerolínea Córdoba", avion = "Boeing 787 Dreamliner", origen_fk = 3, destino_fk = 5 },
                new { id = 19, capacidad = 155, vendido = 0, costo = 127000.00, fecha = DateTime.Parse("2023-10-19 09:00:00"), aerolinea = "Aerolínea Buenos Aires", avion = "Airbus A320", origen_fk = 4, destino_fk = 1 },
                new { id = 20, capacidad = 110, vendido = 0, costo = 115000.00, fecha = DateTime.Parse("2023-10-20 09:00:00"), aerolinea = "Aerolínea Mendoza", avion = "Boeing 747", origen_fk = 5, destino_fk = 2 },
                new { id = 22, capacidad = 110, vendido = 0, costo = 110000.00, fecha = DateTime.Parse("2023-10-25 09:00:00"), aerolinea = "PRUEBA", avion = "PRUEBA", origen_fk = 1, destino_fk = 19 });

            modelBuilder.Entity<ReservaHotel>().HasData(
                new { id = 1, fechaDesde = DateTime.Parse("2023-10-01 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-05 09:00:00.000"), pagado = 150000.00, cantPersonas = 1, hotel_fk = 1, usuarioRH_fk = 1 },
                new { id = 2, fechaDesde = DateTime.Parse("2023-11-15 09:00:00.000"), fechaHasta = DateTime.Parse("2023-11-20 09:00:00.000"), pagado = 120000.00, cantPersonas = 1, hotel_fk = 2, usuarioRH_fk = 2 },
                new { id = 3, fechaDesde = DateTime.Parse("2023-10-03 09:00:00.000"), fechaHasta = DateTime.Parse("2023-11-03 09:00:00.000"), pagado = 170000.00, cantPersonas = 1, hotel_fk = 3, usuarioRH_fk = 3 },
                new { id = 4, fechaDesde = DateTime.Parse("2023-09-20 09:00:00.000"), fechaHasta = DateTime.Parse("2023-09-25 09:00:00.000"), pagado = 140000.00, cantPersonas = 2, hotel_fk = 4, usuarioRH_fk = 4 },
                new { id = 5, fechaDesde = DateTime.Parse("2023-11-01 09:00:00.000"), fechaHasta = DateTime.Parse("2023-11-10 09:00:00.000"), pagado = 110000.00, cantPersonas = 2, hotel_fk = 5, usuarioRH_fk = 5 },
                new { id = 6, fechaDesde = DateTime.Parse("2023-10-08 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-12 09:00:00.000"), pagado = 150000.00, cantPersonas = 2, hotel_fk = 1, usuarioRH_fk = 6 },
                new { id = 7, fechaDesde = DateTime.Parse("2023-12-05 09:00:00.000"), fechaHasta = DateTime.Parse("2023-12-10 09:00:00.000"), pagado = 120000.00, cantPersonas = 1, hotel_fk = 2, usuarioRH_fk = 7 },
                new { id = 8, fechaDesde = DateTime.Parse("2023-09-25 09:00:00.000"), fechaHasta = DateTime.Parse("2023-09-30 09:00:00.000"), pagado = 170000.00, cantPersonas = 1, hotel_fk = 3, usuarioRH_fk = 8 },
                new { id = 9, fechaDesde = DateTime.Parse("2023-11-12 09:00:00.000"), fechaHasta = DateTime.Parse("2023-11-17 09:00:00.000"), pagado = 140000.00, cantPersonas = 2, hotel_fk = 4, usuarioRH_fk = 9 },
                new { id = 10, fechaDesde = DateTime.Parse("2023-12-20 09:00:00.000"), fechaHasta = DateTime.Parse("2023-12-25 09:00:00.000"), pagado = 110000.00, cantPersonas = 2, hotel_fk = 5, usuarioRH_fk = 10 },
                new { id = 1002, fechaDesde = DateTime.Parse("2023-10-20 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-24 09:00:00.000"), pagado = 150000.00, cantPersonas = 1, hotel_fk = 1, usuarioRH_fk = 3 },
                new { id = 2007, fechaDesde = DateTime.Parse("2023-10-25 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-31 09:00:00.000"), pagado = 120000.00, cantPersonas = 1, hotel_fk = 2, usuarioRH_fk = 1024 },
                new { id = 2008, fechaDesde = DateTime.Parse("2023-10-11 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-18 09:00:00.000"), pagado = 110000.00, cantPersonas = 1, hotel_fk = 5, usuarioRH_fk = 1024 },
                new { id = 2009, fechaDesde = DateTime.Parse("2023-10-25 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-25 09:00:00.000"), pagado = 160000.00, cantPersonas = 1, hotel_fk = 6, usuarioRH_fk = 1024 },
                new { id = 2010, fechaDesde = DateTime.Parse("2023-10-23 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-23 09:00:00.000"), pagado = 135000.00, cantPersonas = 1, hotel_fk = 7, usuarioRH_fk = 1024 },
                new { id = 2011, fechaDesde = DateTime.Parse("2023-10-02 09:00:00.000"), fechaHasta = DateTime.Parse("2023-10-05 09:00:00.000"), pagado = 110000.00, cantPersonas = 1, hotel_fk = 5, usuarioRH_fk = 1024 });
